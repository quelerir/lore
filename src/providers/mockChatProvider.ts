...
const mockReplies = [
  ...
  "Я бы собрал ответ в три строки: сигнал, интерпретация, следующий шаг. Так summary читается быстрее и не теряет смысл.",
  "Если нужна версия для board, полезно добавить одно конкретное действие и срок, чтобы обсуждение не зависало в деталях.",
];
...
export class MockChatProvider implements ChatProvider {
  ...
  async regenerateMessage(
    ...
    const reply =
      "Переформулирую короче: оставьте только главный сигнал, одно последствие для бизнеса и точечный запрос к руководителю. Этого достаточно, чтобы разговор оставался управленческим.";
